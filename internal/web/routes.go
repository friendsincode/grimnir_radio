		...
		r.Route("/dashboard", func(r chi.Router) {
			...
			r.Group(func(r chi.Router) {
				...
				r.Route("/media", func(r chi.Router) {
					...
					r.With(h.RequireStationPermission("edit_metadata")).Post("/reanalyze-durations/reset-stuck", h.MediaReanalyzeDurationsResetStuck)
				...
				r.Route("/schedule", func(r chi.Router) {
					...
					r.Post("/report/refresh", h.ScheduleRefreshReport)
				...
				r.Route("/analytics", func(r chi.Router) {
					...
					r.Get("/history/export.csv", h.AnalyticsHistoryExportCSV)
					r.Get("/spins", h.AnalyticsSpins)
					r.Get("/spins/export.csv", h.AnalyticsSpinsExportCSV)
