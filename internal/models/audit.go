...
const (
	...
	AuditActionPlayoutQueueAdd    AuditAction = "playout.queue.add"
	AuditActionPlayoutQueueMove   AuditAction = "playout.queue.move"
	AuditActionPlayoutQueueDelete AuditAction = "playout.queue.delete"
	AuditActionPlayoutSkip        AuditAction = "playout.skip"
	AuditActionPlayoutStop        AuditAction = "playout.stop"
	AuditActionPlayoutReload      AuditAction = "playout.reload"
...
type AuditLog struct {
	...
	ResourceID   string         `gorm:"type:uuid;serializer:nulluuid"` // ID of the affected resource
