# <public-hostname>-AI: Optimized Station Blueprint

> Built from studying the existing <public-hostname> schedule entry-by-entry.
...
```
Primary Source:    Webstream (https://<public-hostname>/behind-the-woodshed)
...
- <public-hostname>-AI syndicates by pulling `https://<public-hostname>/behind-the-woodshed`
...
| Name | URL | Schedule |
|------|-----|----------|
| Liberty Tunes (Unkle Bonehead) | `https://<public-hostname>/liberty-tunes` | Fri 7–9 PM, Sat 2–4 PM |
| Behind the Woodshed (Hal) | `https://<public-hostname>/behind-the-woodshed` | Sun 1:50–4 PM |
...
- [ ] Configure Liberty Tunes webstream (`https://<public-hostname>/liberty-tunes`)
- [ ] Add Behind the Woodshed webstream (`https://<public-hostname>/behind-the-woodshed`)
